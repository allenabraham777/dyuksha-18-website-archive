<?php
    ...
    $list[0]->post =$list[1]->post =$list[2]->post = '<i class="fas fa-users"  style="width:25px;"></i> Coordinator';;
    ...
    $list[4]->image = "images/alvin.jpeg";
    ...
    $list[5]->image = "images/a3.png";
    $list[5]->name = 'Paul P Joby';
    $list[5]->post = '<i class="fas fa-globe"  style="width:25px;"></i> Website Support';
    $list[5]->phone = "9747730514";
    $list[5]->email = "name@dyuksha.org";

    $list[6]->image = "images/a5.jpg";
    $list[6]->name = "Allen K Abraham";
    $list[6]->post = '<i class="fas fa-globe" style="width:25px;"></i> Website Support';
    $list[6]->phone = "8137073386";
    $list[6]->email = "name@dyuksha.org";
?>